      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {futureTechSectors.map((sector) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 opacity-80 group-hover:opacity-100 transition-opacity duration-300"></div>

            <div className="absolute inset-0 flex flex-col justify-end p-4 transition-all duration-300">
              <h3 className="text-xl font-semibold text-primary mb-1 group-hover:mb-3 transition-all duration-300">
                {sector.title}
              </h3>
